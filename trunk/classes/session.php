...
class session {
  ...
  function login ($login, $pw) {
    ...
    $query = "SELECT id AS playerid,password FROM players WHERE name=\"$login\"";
  ...
  function logged_in() {
    ...
    $query = "SELECT password,wins,losses,ties FROM players WHERE name=\"$login\"";
    $result = $mysql->query_assoc($query);
  ...
  function check_authorization() {
    ...
    $login = $_SESSION['login'];
    $pw = $_SESSION['password'];
    $query = "SELECT password FROM players WHERE name=\"$login\"";
    $result = $mysql->query_assoc($query);
  ...
  function is_admin() {
    ...
    $login = $_SESSION['login'];
    $pw = $_SESSION['password'];
    $query = "SELECT administrator FROM players WHERE name=\"$login\"";
    $result = $mysql->query_assoc($query);
    extract($result);

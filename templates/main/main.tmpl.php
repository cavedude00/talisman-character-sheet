<table class="edit_form">
		...
		<center><a onClick="return confirm('Are you sure you wish to be an asshole?');" href="index.php?editor=main&gameid=<?=$gameid?>&charid=<?=$charid?>&action=12">Everybody Loses</a><br></center>
		<center><a onClick="return confirm('Are you sure you wish declare yourself the winner?');" href="index.php?editor=main&gameid=<?=$gameid?>&charid=<?=$charid?>&action=8">Declare Yourself Winner</a><br></center>
              <center><a onClick="return confirm('Are you sure you wish to declare your alignment the winners?');" href="index.php?editor=main&gameid=<?=$gameid?>&charid=<?=$charid?>&action=11">Alignment Wins</a><br></center>
